...
if __name__ == '__main__': 
    ...
    #train_model(cfg.det_head, net, train_loader, criterion_cls, criterion_reg, cfg.cls_loss_weight, cfg.reg_loss_weight, cfg.num_nb, optimizer, 60, scheduler, save_dir, 60, device, 'pure_supervised_' + cfg.backbone)

    weight_file = 'D:/project/PIPNet/snapshots/nAFLW/pip_32_16_60_r18_l2_l1_10_1_nb10/pure_supervised_resnet18_epoch59_bs96.pth'
    state_dict = torch.load(weight_file, map_location=device)
    net.load_state_dict(state_dict)

    if cfg.curriculum:
    # self-training with curriculum
        # task_type_list = ['std', 'std']
    ...
    if not os.path.exists('./graphs'):
        os.makedirs('./graphs')
    graphfilename = os.path.join('./graphs',"resnet18_nme_60.png")
